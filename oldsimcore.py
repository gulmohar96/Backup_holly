...
class Actor(object):
    ...
    def actor_utility(self):
        #Cursors 
        food_cursor = self.resources.food
        water_cursor = self.resources.water
        sleep_cursor = self.resources.sleep
        #Need graphs 
        food_need = 1 - food_cursor ** 0.5
        water_need = 1 - water_cursor ** 2
        sleep_need= 1 - sleep_cursor ** 0.1
    ...
    def normal_life(self):
        # will return cooler things later
...
accident = Provider("Accident", 50, Resources(-0.7, -0.4, -0.5))
